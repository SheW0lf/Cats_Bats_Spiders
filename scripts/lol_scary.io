...
Language: LOLCODE
Github: https://github.com/taoistmath

Makes use of LOLCODE designed by github user justinmeza
Install instructions can be found here: https://github.com/justinmeza/lci
After installing this program can be run by calling $lci lol_scary.io
Helper file can be found here: https://github.com/justinmeza/lolcode-spec/blob/master/v1.2/lolcode-spec-v1.2.md
TLDR
